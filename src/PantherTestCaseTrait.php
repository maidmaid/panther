...
trait PantherTestCaseTrait
{
    ...
    public static function startWebServer(array $options = []): void
    {
        ...
        $options = [
            'webServerDir' => $options['webServerDir'] ?? static::$webServerDir ?? $_ENV['PANTHER_WEB_SERVER_DIR'] ?? self::$defaultOptions['webServerDir'],
            'hostname' => $options['hostname'] ?? self::$defaultOptions['hostname'],
            'port' => (int) ($options['port'] ?? $_ENV['PANTHER_WEB_SERVER_PORT'] ?? self::$defaultOptions['port']),
            'router' => $options['router'] ?? $_ENV['PANTHER_WEB_SERVER_ROUTER'] ?? self::$defaultOptions['router'],
        ];
